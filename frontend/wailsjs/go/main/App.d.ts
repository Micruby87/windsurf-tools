...
export function ActiveAccount():Promise<models.ProviderAccount|boolean>;
...
export function GetActiveAccount():Promise<models.ProviderAccount>;
...
export function NextActiveAccount():Promise<models.ProviderAccount>;
...
export function RouteMode():Promise<string>;
